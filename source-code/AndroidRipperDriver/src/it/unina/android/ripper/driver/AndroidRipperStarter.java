...
public class AndroidRipperStarter implements RipperEventListener {
	...
	public void startRipping()
	{
		...
		if (conf != null)
		{
			...
			// 终止条件 改为 不终止
			String terminationCriterionClass = conf.getProperty("termination_criterion", ((driverType.equals("r"))?"it.unina.android.ripper.termination.MaxEventsTerminationCriterion":"it.unina.android.ripper.termination.NullTermination"));//"it.unina.android.ripper.termination.EmptyActivityStateListTerminationCriterion"));
